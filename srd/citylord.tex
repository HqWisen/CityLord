...
\paragraph{}
Le but de ce projet est de créer, et de coder le jeu CityLord.
CityLord est un jeu du type \textit{point and click} en ligne, dans lequel 2 à 8 joueurs sont propriétaires de bâtiments dans une même ville.
Le but du jeu étant d’être le dernier propriétaire, les joueurs doivent, tout-au-long de la partie, acheter et vendre des terrains afin de maximiser son capital et son profit.
Au cours de ce projet, notre groupe sera en contact avec les différents concepts vus aux cours de Système d’exploitation (tels que la programmation réseau)
et d’Analyse et méthode informatique (tels que la programmation orienté Objet ou l’utilisation de diagramme de classe).
\paragraph{}
Nous allons également connaître l’expérience d’un travail de groupe plus nombreux, dont les membres ont été choisis au hasard – et que, par conséquent,
ne sont pas ceux avec qui nous voulions travailler- et cela nous donnera l’expérience des conditions de travail dans une entreprise.
À la fin de la réalisation de celui-ci, nous apprendrons la sensation du travail bien fait, le sens des responsabilités et de la ponctualité ainsi que l’expérience du lien entre le programmeur
et le client.
\section{Glossaire}
\begin{itemize}
...
\section{Exigences non fonctionnelles}
\begin{itemize}
 \item Le client et le serveur doit etre ecrit en C++ et compilé avec \textbf{g++}.
\end{itemize}
...
\begin{figure}[ht]
    \makebox[\linewidth]{
        \includegraphics[width=550pt]{uml/classDiagrams/base.png}
    }
