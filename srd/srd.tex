...
\hline
16/02/2015 & 2.2 & \parbox{7cm}{-\\ Modification du Use Case de "Log In", plus de utilisateur hôte mais un serveur \& modification des besoins non-fonctionels\\} & David \\
\hline
...
\subsection{Service}
\paragraph{}Ergonomie:  \newline
Le système sera esthétique et disposera donc d’une apparence claire, afin que le joueur puisse repérer les options dont il a besoin facilement et rapidement.
